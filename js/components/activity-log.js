...
const ACTION_LABELS = {
  ...
  create_brand: 'Đã tạo thương hiệu', update_brand: 'Đã chỉnh sửa thương hiệu', delete_brand: 'Đã xóa thương hiệu',
...
const MODULE_LABELS = { orders: 'Đơn hàng', customers: 'Khách hàng', employees: 'Nhân viên', payments: 'Thanh toán', returns: 'Trả hàng', cashbook: 'Sổ quỹ', suppliers: 'Nhà cung cấp', purchases: 'Mua hàng', products: 'Sản phẩm', brands: 'Thương hiệu', pricelists: 'Bảng giá' };
