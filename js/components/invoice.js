...
import { dbSaveOrder, dbCreateQuickCustomer, dbConfirmOrder, dbAmendOrder, dbFetchOrderDebtSnapshot, dbLoadCustomerAssignedPricing, dbRefreshCustomerFinancialState, dbRefreshOrderById, cacheOrdersLocally, isCloudActive } from '../services/supabase.js?v=20260817-saas-platform-v6';
import { renderAll, switchTab } from '../main.js?v=20260817-saas-platform-v6';
import { tenantStorage } from '../services/tenant-storage.js';
import { populatePricelistsDropdowns } from './pricelists.js?v=20260817-saas-platform-v6';
import { generateUniqueCustomerCode } from './customers.js?v=20260817-saas-platform-v6';
import { addCashbookTransaction } from './so_quy.js?v=20260817-saas-platform-v6';
import { getApplicablePriceList, resolveCustomerProductPrice, normalizePriceListType, PRICE_LIST_TYPES, filterPriceListsForUser, canUserViewPriceList, canUserUsePriceListForCustomer, isDealerPrivatePriceList, isUsableResolvedPrice, shouldOverrideWithGlobalCustomerPriceList } from '../domain/pricing.js?v=20260817-saas-platform-v6';
import { normalizeCustomerPhone } from '../domain/customer-query.js';
import { isPrintOnlyPriceList, requiresOrderSaveApproval, supportsInvoiceLineDiscount } from '../domain/invoice-discount.js?v=20260817-saas-platform-v6';
...
import { chargeCustomerDebt, getOrderDebtSnapshot, getOrderOutstandingAmount } from '../domain/customer-debt.js?v=20260817-saas-platform-v6';
